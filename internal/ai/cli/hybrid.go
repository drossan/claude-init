...
// HybridClient usa el Wrapper directo.
//
...
// El Wrapper con -p es más lento pero 100% fiable.
...
// NewHybridClient crea un nuevo cliente híbrido (usa solo Wrapper).
...
// SendMessage envía un mensaje usando Wrapper.
