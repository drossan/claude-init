...
// Client es un cliente para la API de Z.AI.
type Client struct {
	apiKey    string
	baseURL   string
	model     string
...
// NewClient crea un nuevo cliente de ZAI.
...
// chatRequest representa una solicitud compatible con OpenAI.
...
// SendMessage envía un mensaje a ZAI y retorna la respuesta.
